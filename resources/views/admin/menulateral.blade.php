<div class="w-[20%] bg-white border-r-2 border-black py-10 px-6 min-h-screen">
    ...
    <ul class="space-y-4 text-lg">
        ...
        <li class="flex items-center gap-2">
            ...
            <a href="{{ route('admin.peliculas') }}" class="{{ request()->routeIs('admin.peliculas') ? 'font-bold text-text-color' : 'text-black' }}">
                Películas
            </a>
        </li>
        ...
        <li class="flex items-center gap-2">
            ...
            <a href="{{ route('admin.sesiones') }}" class="{{ request()->routeIs('admin.sesiones') ? 'font-bold text-text-color' : 'text-black' }}">
                Sesiones
            </a>
        </li>
        ...
        <li class="flex items-center gap-2">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="M3 7.5V6a3 3 0 0 1 3-3h12a3 3 0 0 1 3 3v1.5m-18 0v9a3 3 0 0 0 3 3h1.5m-4.5-12h18m0 0v9a3 3 0 0 1-3 3h-1.5m-9 0h6" />
            </svg>
            <a href="{{ route('admin.salas') }}" class="{{ request()->routeIs('admin.salas') ? 'font-bold text-text-color' : 'text-black' }}">
                Salas
            </a>
        </li>
        <li class="flex items-center gap-2">
